...
from keras.layers.core import Dense, Dropout, Activation, Flatten3D
from keras.layers.convolutional import Convolution3D, MaxPooling3D
from keras.optimizers import RMSprop
from melanoma.cnn.melanoma_dataset import MelanomaDataset3D, MelanomaDataset2D

# @Author: Jake Varley, Minhaz Palasara
# This class has a handler for cnn training,
# It is used for model (2D or 3D) training, resuming training, serializing trained model and
# Cross validation.
class MelanomaModel:
